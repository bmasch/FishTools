...
doCalc= function(){
  ...
  if(type=="A"){
	...
	dat <- phos.mhatch.main2(x1=x1,x2=x2,Eu=Eu,theta=theta,lambda=lambda,phi=phi)
	tmp <- list(x1=dat$x1,
	x2=dat$x2,
	Eu=dat$Eu,
	theta=dat$theta,
	...
	dat <- phos.mhatch.main1(Nsims=Nsims,x1=x1,x2=x2,Eu=Eu,theta=theta,lambda=lambda,phi=phi)
	tmp <- list(x1=dat$x1,
	x2=dat$x2,
	Eu=dat$Eu,
	theta=dat$theta,
